...
ACLOCAL = ${SHELL} /home/ubuntu/snort/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/ubuntu/snort/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/snort/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/snort/missing automake-1.15
AWK = gawk
CC = gcc
...
CPP = gcc -E
CPPFLAGS = -DGRE -DMPLS -DPPM_MGR -DNDEBUG -DENABLE_REACT -DENABLE_RESPOND -DENABLE_RESPONSE3 -DSF_WCHAR -DTARGET_BASED -DPERF_PROFILING -DSNORT_RELOAD -DNO_NON_ETHER_DECODER -DNORMALIZER -DACTIVE_RESPONSE
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LEX = flex
LIBOBJS = 
LIBS = -lz -ldaq_static -ldumbnet -lpcre -lpcap -lnsl -lm -lm  -ldl -L/usr/local/lib -ldaq_static_modules  -lsfbpf -lpcap -lsfbpf -lnfnetlink -lnetfilter_queue -lsfbpf -lpcap -L/usr/lib -ldumbnet -lz -lpthread -lpthread -lpthread
...
LUA_LIBS = 
MAINT = #
MAKEINFO = ${SHELL} /home/ubuntu/snort/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
XCCFLAGS = 
YACC = bison -y
abs_builddir = /home/ubuntu/snort
abs_srcdir = /home/ubuntu/snort
abs_top_builddir = /home/ubuntu/snort
abs_top_srcdir = /home/ubuntu/snort
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/ubuntu/snort/install-sh
